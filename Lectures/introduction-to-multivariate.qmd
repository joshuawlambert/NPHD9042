...
[**Download R Code for this Lecture**](code/introduction-to-multivariate.R){ .btn .btn-primary }
...
Use the <a href="Owl Diet.csv" download>Owl Diet.csv</a> dataset to complete the example Discriminant Analysis. The Owl Diet dataset contains fictional information about types of owl diets.
