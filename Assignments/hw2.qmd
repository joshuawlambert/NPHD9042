...
Follow each step and provide tables, figures, and explanations when appropriate. <a href="HW2.csv" download>HW2.csv</a> dataset and answer the following questions using a statistical software of your choice. NHANES
