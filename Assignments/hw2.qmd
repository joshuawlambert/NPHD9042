...
Follow each step and provide tables, figures, and explanations when appropriate. Use the <a href="NHANES DATASET DOWNLOAD" download>HW2.csv</a> dataset and answer the following questions using a statistical software of your choice. NHANES
